...
public final class LanguageMenuOrder {
    ...
    public static String simplifiedLabel(){return Locale.forLanguageTag("zh-Hans").getDisplayName(locale());}
    ...
    static String label(String code){return Locale.forLanguageTag(code==null?"":code).getDisplayName(locale());}
